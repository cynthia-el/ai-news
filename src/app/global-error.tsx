...
export default function GlobalError({
  ...
  return (
    <html>
      <body className="min-h-screen flex items-center justify-center bg-[#f4f6f9]">
        <div className="text-center space-y-4">
          ...
          <h2 className="text-lg font-semibold text-slate-900">应用加载出错</h2>
          <p className="text-sm text-slate-500">{error.message || '发生了未知错误'}</p>
          <button
            onClick={() => reset()}
