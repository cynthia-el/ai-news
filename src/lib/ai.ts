...
★ 1-2分（垃圾内容，坚决排除）：
- 广告软文、品牌宣传稿、招商加盟、诚招代理
- 采购询价、B2B求购信息（如"需要采购XX"、"咨询XX价格"、"求购XX材料"）
- 招聘求职、培训课程推销
- 明显的产品推销、促销信息
- 与家居建材产业完全无关的内容
- 标题党、内容空洞的自媒体水文
- 房产销售、家装公司自我宣传
- 内容乱码、无法阅读、全是符号的
- 过时的旧闻（如2024年及更早的展会报道、已发生事件的事后回顾无新信息）

【特别注意 — 严格执行】
- 如果一条资讯主要是"XX品牌最好"、"选XX就对了"、"限时优惠"、"加盟热线"这类推销话术，直接给1-2分
- 如果是B2B采购询价（标题以"咨询""需要采购""求购""询价"开头，内容为企业采购需求），直接给1-2分，这不是行业资讯
- 如果是招商代理信息（"诚招全国代理"、"厂家招商"、"品牌加盟"），直接给1-2分
- 如果是"十大品牌排行""XX评测：XX品牌位居榜首"这类软文，给2-3分
